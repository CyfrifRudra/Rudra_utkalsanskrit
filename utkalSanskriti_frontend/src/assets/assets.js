...
export const blogData = [
  ...
  {
    id: 1,
    image: "/chilika-img/chilik-1.jpg",
    title: "Puri",
    description: "The Puri Rath Yatra, also known as the Chariot Festival, is one of the most sacred and grand festivals of India."
  },
  {
    id: 2,
    image: "/chilika-img/chilika-2.jpg",
    title: "Konark",
    description: "The Puri Rath Yatra, also known as the Chariot Festival, is one of the most sacred and grand festivals of India."
  },
  {
    id: 3,
    image: "/chilika-img/chilika-3.jpg",
    title: "Chilika",
    description: "The Puri Rath Yatra, also known as the Chariot Festival, is one of the most sacred and grand festivals of India."
  },
  {
    id: 4,
    image: "/chilika-img/chilika-3.webp",
    title: "Bhubaneswar",
    description: "The Puri Rath Yatra, also known as the Chariot Festival, is one of the most sacred and grand festivals of India."
  }
  ...
  //puri district 
  {
    ...
    products: [
      ...
      },
      {
        ...
        image_arr: ["/shaktipitha-img/ramachandi-temple.jpg", "/puri-img/ramchandi-temple.jpg"],
        ...
        festivals: [
          {
            ...
            img: ["/puri-img/durgapuja-ramchandi.webp", "/puri-img/dusshera-img.jpg"],
      ...
      },
      {
        ...
        image_arr: ["/puri-img/markendeswar-temple.jpg", "/puri-img/markandeswar-1.jpg", "/puri-img/markandeswar-2.jpg", "/puri-img/markandeswar-3.jpg"],
        ...
        festivals: [
          {
            name: [`Ashokashtami`, `Maha Shivaratri`, ` Rishi Panchami`],
            img: [],
      ...
      },
      {
        ...
        image_arr: ["/puri-img/beleswartemple.jpg", "/puri-img/beleswar-temple-image.png"],
      ...
      },
      {
        ...
        about_rituals: [`The temple doors are opened, and the deity is symbolically awakened with the ringing of bells and chanting of prayers.`,
          `Priests perform the abhisheka, gently bathing the idol of Lord Alarnath with sacred water, and sometimes other auspicious liquids. This cleansing ritual is a significant part of the morning routine.`,
          ` Following the bath, the deity is dressed in new clothes and adorned with flowers, garlands, and various ornaments. This decoration is done with great attention to detail, enhancing the divine appearance of Lord Alarnath.`,
          `Food offerings are made to the Lord at different times of the day.A lighter breakfast offering is presented.`,
          ` A more elaborate meal consisting of cooked rice, dal, vegetable curries, and the special kheer is offered. The priests meticulously arrange the food before the deity.`,
          `A simpler meal, often including khechudi, pithas, and fried plantains, is offered before the deity is put to rest.`,
          `During the morning and evening, priests perform the aarti. They wave lamps filled with ghee or camphor before the image of Lord Alarnath while chanting prayers and devotional songs. The light from the lamps is believed to carry the devotees' prayers to the Lord.`,
          `Throughout the day, the temple remains open for devotees to have darshan. They stand before the deity with folded hands, offering their prayers and seeking blessings. The atmosphere during darshan is usually filled with devotion and reverence.`
        ],
        festivals: [
          {
            name: [`Anavasara`,`Ratha Yatra` ],
            img: [ ],
            description: [ ` This is arguably the most important period for the Alarnath Temple. Occurring for about 14-15 days after the Snana Yatra (bathing festival) of Lord Jagannath in Puri (typically in June/July), the deities of the Jagannath Temple are said to be resting and are not available for public viewing. During this time, devotees believe that Lord Jagannath manifests as Lord Alarnath. Thousands of devotees flock to the Alarnath Temple for darshan and to partake in the special offering of kheer (sweet rice pudding), which is believed to be Lord Alarnath's favorite.`,
              ` While the main Ratha Yatra takes place in Puri, a smaller-scale chariot festival of Lord Alarnath is also observed within the temple premises. Idols are placed on a chariot and pulled around the temple grounds amidst singing, dancing, and chanting.`
            ],
          }
        ],
        calender: [
      ...
      },
      {
        ...
        rituals_img: [null,"/puri-img/Dwaraphita.png", "/puri-img/mangala_alati.jpg", "/puri-img/mallam.jpg", "/puri-img/ABAKASHA.png", "/puri-img/MAILAM-BESHALAGI.png", null, "/puri-img/rosaghara.jpg", null, null, "/puri-img/Gopal-ballava-bhoga.webp", "/puri-img/sakaldhupa_puja.jpg", "/puri-img/Maa-Subhadra-MALIALM.png", null, "/puri-img/MADHYAM-DHUPA.jpg", "/puri-img/sandhya_alati.jpg", null, "/puri-img/chandanalagi.jpg", null, "/puri-img/Bada-Singhara-Besha.jpg", null ],
        rituals_name: [`Disclaimer`,`DWARAPHITA(OPENING OF THE DOORS)`, `MANGALA ALATI(AUSPICIOUS LAMP OFFERING)`, `MAILAM(REMOVAL OF DRESS FLORAL DECORATON)`, `ABAKASHA`, `MAILAM,BESHALAGI`, `SAHANAMELA`, `ROSHA HOMA(FIRE SACRIFICE IN THE KITCHEN)`, `SURYA PUJA(WORSHIP SUN)`, `DWARAPALA PUJA`, `GOPAL BALLAVA BHOGA`, `SAKALA DHUPA (MORNING FOOD OFFERING)`, `MAILAMA`, `BHOGA MANDAPA`, `MADHYANA DHUPA`, `MADHYANA PAHUDA`, `SANDHYA ALATI`, `SANDHYA DHUPA`, `MAILAM AND CHANDANLAGI`, `BADASINGHARA BESA`, `BADASINGHARA DHUPA`, `KHATASEJA LAGI AND PAHUDA`],
        about_rituals: [`The Gundicha Temple, while famously associated with the Rath Yatra, primarily serves as the temporary abode of Lord Jagannath, Lord Balabhadra, and Devi Subhadra for seven days during this annual festival. Therefore, it doesn't have an elaborate set of daily rituals performed throughout the year like the main Jagannath Temple (Shree Mandira).However, during the deities' seven-day stay in the Gundicha Temple (part of the nine-day Rath Yatra), rituals similar to those performed at Shree Mandira are conducted`,
                        `The temple's gates are opened at precise times for darshan (viewing of the deity) by the public, and this opening is conducted with utmost reverence and ritual precision. It is believed that the temple's doors are "opened" by the divine grace of Lord Jagannath, symbolizing the invitation for devotees to come closer to the deity.`,
          `During the Mangala Alati, the temple priests offer prayers and light sacred lamps to wake up Lord Jagannath, Lord Balabhadra, and Goddess Subhadra. The ritual involves chanting hymns and mantras while the priests perform the arti (a ceremonial offering of light) using several oil lamps, known as "Diyas", to invoke the divine presence of the deities. This ritual is deeply symbolic, as it signifies the awakening of the deities to bless the devotees.`,
          `During the Mailam, the deities are offered a special kind of lighted offering or lamp and incense as a way to honor and invoke their presence.
             The ritual is part of the larger daily worship cycle, which includes offerings, prayers, and hymns to the deities—Lord Jagannath, Lord Balabhadra, and Goddess Subhadra. The Mailam is often done with the chanting of sacred mantras and is believed to purify the environment and bless the devotees with divine grace.`,
          `Abakash means brushing of teeth and bathing of deities. This nitis are performed by servitors like Pushpalak, Suarbadu, Paniapat, Mukhapakhal sevak, Khuntia, Darpania,Mukhapakhal sevak, Khuntia, Darpania,Pratihari, Amla Ghatuary, Bhandar Mekap,Mahabhoi and Khurinayak.
        ...
        festivals: [
          {
            ...
            img: [ ],
            description: [ `A day before the Rath Yatra, the Gundicha Temple is meticulously cleaned by devotees, symbolizing the cleansing of the heart to welcome the divine.`,
              ...
              ` On the fifth day of the deities' stay at the Gundicha Temple, a unique ritual takes place. Goddess Lakshmi, the consort of Lord Jagannath, is believed to visit the Gundicha Temple in the form of Subarna Mahalakshmi, expressing her anger at being left behind.`,
              `The day after Hera Panchami, the chariots are turned to face the Nakachana Gate (eastern gate) of the Gundicha Temple, in preparation for the return journey (Bahuda Yatra). This marks the beginning of the three-day Rasa Lila of Jagannath.`,
              `The day before the Bahuda Yatra is considered very auspicious. Devotees throng the Gundicha Temple for the evening viewing (Sandhya Darshan) of the deities on the 'Adap Mandap' (the sacred throne inside the Gundicha Temple). It is believed that witnessing the deities here on this particular evening is highly rewarding.`,
              ` On the ninth day of the festival, the deities are brought back to their chariots and the return journey to the main Jagannath Temple begins.`,
              ` After reaching the main temple, the deities are adorned with a magnificent golden attire (Suna Besha) on their chariots, a spectacular event witnessed by countless devotees.`
            ],
          }
        ],
        calender: [
      ...
      },
      {
        ...
        about_rituals: [`Devotees typically start their day by offering flowers, fruits, and incense to the goddess. This is often accompanied by chanting mantras and reciting stotras dedicated to Varahi,`,
          `The temple practices the unique ritual of offering fish to Goddess Varahi daily. This practice aligns with Tantric rituals,`,
          `The temple follows Tantric rituals for worshipping Varahi. This is reflected in the unusual offering of fish and the timing of worship. `,
          `According to Tantra, Varahi is ideally worshipped after sunset and before sunrise, with the middle of the night being the most auspicious time`
        ],
        festivals: [
          {
            ...
            description: [ `This major Hindu festival dedicated to Goddess Durga is celebrated with special fervor at the Varahi Temple, usually in the month of Ashwin (September-October). The nine nights (Navaratri) leading up to Dussehra involve special pujas, decorations, and possibly cultural programs dedicated to the divine feminine energy. The "Shola Puja" mentioned in some sources is likely a part of these Navaratri celebrations.`,
              `Celebrated in the month of Chaitra (March-April), this festival is significant in Odisha and likely observed at the Varahi Temple with special rituals and prayers.`
            ],
          }
        ],
        calender: [
    ...
    products: [
      {
        ...
        latitude: '20.08580249679063',
        longitude: '86.28058618188487',
        temple: "yes",
        heritage_sites: "yes",
        chari_khetra: "no",
        shakti_pitha: "yes",
        ...
        festivals: [
          {
            ...
            img: [null, null, "/jagatsinghpur-img/maa-sarala-chandan yatra.jpg"],
      ...
      },
      {
        ...
        location: "KUNDESWAR,JAGATSINGHPUR,ODISHA",
        latitude: 19.999916689305486,
        longitude: 86.1947479835451,
        temple: "yes",
        heritage_sites: "no",
        ...
        image: "",
        image_arr: [],
        description:  "Trilochaneswar Mahadev is the presiding deity of this place. This temple has built before the Lingraj temple of Bhubaneswar. ",
        price: "$999",
        details:  `The historic Trilochaneswar Temple, enshrining Lord Trilochaneswar Mahadev, is situated near Kundeswar village, roughly 16 km from Jagatsinghpur. Believed to have been built before the renowned Lingaraj Temple in Bhubaneswar, this temple comes alive during Maha Shivaratri and Dola Yatra, attracting thousands of devotees each year.
        The name "Trilochaneswar" refers to Lord Shiva as the "Lord with Three Eyes." This is a fundamental aspect of Shiva's iconography, symbolizing his ability to see past, present, and future, as well as his immense power and connection to cosmic time.
        The presiding deity is a Shiva Linga, which itself is a symbol of the formless and limitless nature of Lord Shiva. Its presence signifies the eternal and all-pervading aspect of the divine. Maa Harachandi is worshipped as the Nagar Devi (protector goddess) of Kundinagar, highlighting the symbiotic relationship between Shiva and Shakti traditions, common in Odisha's religious landscape. Iconographic evidence suggests Maa Harachandi is closely associated with the Chamunda form of Durga.
         The temple is a significant center for local devotees, especially during festivals like Maha Shivaratri and Dola Yatra, where thousands gather to offer prayers and seek blessings. `,
        rituals_img: [null,null,null,null,null,null],
        rituals_name: [`Morning Ablutions and Opening`,`Mangala Aarti`,`Abhisheka`,`Puja and Offerings`,`Sandhya Aarti`,`Closing Rituals`],
        about_rituals: [`The temple doors would be opened in the morning, likely accompanied by the cleaning of the temple premises and the deities.`,
          `This is an auspicious morning ritual involving the waving of lamps before the deity, accompanied by prayers and chanting.`,
          `The Shiva Linga is likely bathed with water, milk, ghee, honey, and other sacred substances. This is a common and important ritual in Shiva temples.`,
          `Priests would perform daily prayers (puja) offering flowers, incense, and perhaps cooked food (bhoga) to Lord Trilochaneswar.`,
          ` An evening ritual similar to the morning aarti, involving lamps and prayers.`,
          `The temple doors would be closed at the end of the day after the final rituals.`
        ],
        festivals: [
          {
            name: [`Maha Shivaratri`,`Jhulan Jatra` ],
            img: [ ],
            description: [ ` This is a major festival dedicated to Lord Shiva, and as the presiding deity is Lord Trilochaneswar Mahadev, this festival would be of significant importance. Thousands of devotees gather at the temple to offer prayers and participate in the night-long vigil.`,
              `The Jhulan Jatra festival at Trilochaneswar Temple in Kundeshwar, Jagatsinghpur, is a significant annual event in Odisha. It is a time for religious observance and local celebration. The festival typically involves various rituals, including processions, prayers, and cultural activities. The festival is a popular event in the region, attracting devotees and visitors alike. 
              The festival often includes prayers, chanting, and the swinging of the idols, which is a central part of the Jhulan Jatra celebration.The idols are often taken out in a procession around the temple and the surrounding areas, allowing devotees to participate in the celebration.The Jhulan Jatra is a time for local communities to gather, share food, and enjoy cultural events`
            ],
          }
        ],
        calender: [
        ...
        history: [
          {
            name: ['Legendary Origin'],
            img: [null,],
            description: [` Its history is significant, with some accounts suggesting it predates the famous Lingaraj Temple in Bhubaneswar.The temple is believed to have been constructed possibly around the 8th century AD or earlier. Some local traditions attribute its construction to the Keshari dynasty King Biswanbara. This would indeed place its origin before the Lingaraj Temple, which is largely dated to the 11th century AD.
              The area surrounding the temple was once a flourishing ancient settlement known as Kundinagar, comprising twelve villages. The Trilochaneswar Temple served as a central religious point for this region.
              The original structure of the temple was built in the Rekha Deula style, a classic form of early Kalinga architecture. The Jagamohana (assembly hall), built in the Pidha Deula style, was added later, likely between the 10th and 11th centuries. This showcases the evolution of temple architecture over time at the site.
              The temple complex includes three smaller shrines in its eastern part, along with a temple kitchen and a small museum. This museum houses 8th-century idols, as confirmed by inscriptions on the sculptures, further solidifying the temple's early historical roots.` ],
          }
        ],
      },
      {
        id: 106,
        name: "AJAIKAPADA BHAIRAVA TEMPLE",
        location: "JAGATSINGHPUR,ODISHA,INDIA",
        latitude: 19.999916689305486,
        longitude: 86.1947479835451,
        temple: "yes",
        ...
        image: "",
        image_arr: [],
        description:  "Ajaikapada Bhairava Temple is dedicated to Ekapada Bhairava an aspect of Shiva. The temple was built during the early 10th century by the Somavamsi Keshari Kings of Orissa",
        price: "$999",
        details:  `The Ajaikapada Bhairava Temple, dedicated to a unique, one-footed form of Lord Shiva called Ekapada Bhairava, is located near Alanahat (Sathalapada) in the Jagatsinghpur district of Odisha, approximately 6 km from Alanahat and near the Alaka River (a branch of the Mahanadi).The most distinctive feature of Ekapada Bhairava is that he is depicted with only one foot.
         The idol in the Ajaikapada Bhairava Temple has four arms, although the lower two are currently broken. The upper two hands hold disc-shaped structures.Ekapada Bhairava represents a fierce (Rudra) aspect of Lord Shiva (Bhairava). The term "Ajaikapada" has Vedic origins, linked to a one-footed deity associated with the cosmos.
         Ekapada is also seen as representing the Axis Mundi or the cosmic pillar of the universe, with Shiva as the Supreme Lord from whom Brahma and Vishnu originate. In Odisha, Ekapada Bhairava is primarily considered a Tantric deity, often associated with the Yogini cult and sometimes depicted with fierce features like a short beard, mustache, bulging eyes, and urdhva-linga (ithyphallic).
         Ekapada Bhairava is sometimes found as a guardian figure at the entrance of Shakti (goddess) temples or as an attendant of the Saptamatrikas (seven mother goddesses).`,
        rituals_img: [],
        ...
        about_rituals: [`The temple doors would be opened in the morning, followed by the cleaning of the temple premises and the idols.`,
          ` An auspicious morning ritual involving the waving of lamps (deepa) before Lord Ekapada Bhairava and the Shiva Linga, accompanied by prayers and chanting.`,
          `The sacred bathing of the Shiva Linga with water, milk, ghee, honey, and other ritualistic substances is a common practice in Shiva temples and would likely be performed here. Given Bhairava's association with Shiva, the Ekapada Bhairava idol might also receive a similar ritualistic bath.`,
          ` Priests would perform daily prayers (puja) offering flowers, incense, and possibly cooked food (bhoga) to both Lord Ekapada Bhairava and the Shiva Linga`,
        ...
        festivals: [
          {
            ...
            img: [ ],
            description: [ `This is the most significant festival dedicated to Lord Shiva and would be celebrated with great fervor at the Ajaikapada Bhairava Temple. Devotees would likely observe fasting, perform special prayers and rituals, and maintain a night-long vigil.`
            ],
          }
        ],
        calender: [
        ...
        history: [
          {
            name: ['Legendary Origin',`Myths and Legends`],
            img: [null],
            description: [ ` As mentioned earlier, the archaeological evidence strongly suggests that the Ajaikapada Bhairava Temple was originally constructed during the reign of the Somavamshi Keshari dynasty in the early 10th century AD. This period was a significant one for temple building and the patronage of Shaivism in Odisha.The Somavamshis were known for their devotion to Lord Shiva, and they built numerous temples dedicated to various forms of the deity. The establishment of a temple dedicated to the unique form of Ekapada Bhairava aligns with this Shaivite patronage.   
                          The iconography of Ekapada Bhairava and the temple's early history indicate its potential as a center for Tantric practices, which were prevalent in Odisha during that era. The worship of Bhairava often involves Tantric rituals.    Unfortunately, the original 10th-century temple did not survive intact. It is believed to have been destroyed due to natural calamities like floods from the nearby Alaka River or possibly during periods of conflict with non-Hindu rulers. The current, smaller Pidha Deula structure was reconstructed in the early 20th century, preserving the ancient deity within its Garbhagriha.`,
                        ` The term "Ajaikapada" finds roots in Vedic literature, where it is associated with a mysterious, one-footed cosmic deity. While the direct link to the Puranic Bhairava is debated, this Vedic connection adds to the ancient and mystical aura of the deity.
                        Ekapada Bhairava is considered a fierce (Rudra) manifestation of Lord Shiva (Bhairava). He embodies the destructive and transformative aspects of the divine.   
                        Some myths portray Ekapada as the primordial Shiva, from whom even Brahma (the creator) and Vishnu (the preserver) originated. This elevates his status to a supreme, foundational deity.
                         In Hindu astrology, Ekapada Bhairava is the ruling deity of the Pūrva Bhādrapadā Nakshatra (star constellation). This astrological significance further enhances his mystical and cosmic importance.   
                        In some interpretations, Ekapada is seen as representing the Axis Mundi, the cosmic pillar that supports the universe. The single foot symbolizes the central, unwavering nature of Shiva as the Supreme Being from whom all creation emanates.
                        `],
          }
        ],
      },
    ...
    products: [
      {
        ...
        latitude: 18.822571070473384,       //doesnot found daily rituals
    ...
    products: [
      {
        ...
        saiva_khetra: "no",
        image: "/sundargarh-img/jagannath-mandir-sundargarh.jpg",
        image_arr: ["/sundargarh-img/jagannath-mandir-sundargarh.jpg"],
    ...
    products: [
      {
        ...
        saiva_khetra: "no",
        image: "/boudh-img/charisambhu-temple-boudh.jpg",
        image_arr: ["/boudh-img/charisambhu-temple-boudh.jpg"],
    ...
    products: [
      {
        ...
        description: ` Goddess Manikeswari has been associated with the history of the Kalahandi region as a deity of wealth ("Manik" meaning ruby or gemstone) since around the 10th century AD`,
        price: "$999",
        details: `Manikeswari is one of the popular Hindu deity in Orissa. There are many Manikeswari temples present in Western and Southern part of Orissa.
                  Manikeswari temple in Bhawanipatna is well recognized in Orissa. Manikeswari is also the primary deity associated with the royal family of Paralakhemundi in Gajapati. Chhatar Jatra is one of the most popoular festival of Manikeswari at Bhawanipatna. Khandasadhaka is a festival associated with Manikeswari in Paralakhemundi. Goddess Manikeswari has been associated with the history of the Kalahandi region as a deity of wealth ("Manik" meaning ruby or gemstone) since around the 10th century AD`,
        rituals_img: [null,null,null],
        rituals_name: [`Awakening and Morning Offerings`,`Afternoon Closure`,`Evening Prayers and Aarti`],
        about_rituals: [`he day begins with the awakening of the deity. The temple priests perform rituals to wake Maa Manikeswari. This is followed by abhisheka (bathing) of the idol with water, milk, and other sacred substances. The deity is then adorned with fresh clothes, jewelry, and flowers. Prayers and hymns are chanted. The first bhog (offering of food), which is usually simple, is presented to the goddess. Devotees start arriving for darshan (viewing the deity) during this time.`,
                         `The temple typically closes in the late morning or early afternoon, allowing for midday preparations and rest.`,
                         `The temple reopens in the late afternoon. The evening rituals include the dressing and adorning of the deity again. Special prayers and devotional songs are recited. The arati ceremony is a significant part of the evening rituals, where lamps are ritually waved before the idol, accompanied by the sounds of bells, drums, and chanting. Another bhog is offered to the goddess, which might be more elaborate than the morning offering. Devotees gather for the evening darshan and to witness the arati. The temple closes for the night after the evening rituals are completed.`
        ],
        festivals: [
          {
            name: [`Chhatar Yatra`,`Munda Basa`,`Nabanna`],
            ...
            description: [`Chhatra Jatra, also known as Chatar Jatra or Chatar Yatra, is a vibrant and spiritually significant festival celebrated with great enthusiasm in Kalahandi, Odisha. Held during Mahastami of Durga Puja, this festival symbolizes the victorious spirit of the divine and marks the celebration of Vijaya Utsav. One of the unique aspects of this event is the ritual practice of the Khonds, the indigenous tribal community of the region, who observe Nabakalevar—a symbolic renewal of worship practices during the festivities.
                           ...
                           This is the grandest festival dedicated to Maa Manikeswari, celebrated during the Dussehra festival (usually in September-October).On the midnight of Mahashtami (the eighth day of the waxing fortnight of Ashwin), the sacred chhatar of the goddess is taken in a grand procession from the temple to Jenakhal, a place about 3 kilometers away. This procession is accompanied by traditional music, including the resonating sounds of ghanta (large bells), drums, and other tribal instruments. Devotees, often in large numbers, participate in this night-long walk.
                            Special rituals are performed at Jenakhal. Traditionally, this was the site for animal sacrifice offered to the goddess. Despite the ban, some devotees still carry out this practice in adherence to old customs.On the morning of Mahanavami (the ninth day), the chhatar is brought back to the temple in another vibrant procession. The atmosphere is filled with devotion and celebration. Thousands of devotees throng the streets to witness the return of the goddess's symbol.`,
                          ` This is a unique and somewhat secretive ritual observed on the midnight of Mulastami (the eighth day of the dark fortnight of Aswina). The central ritual involves the symbolic replacement of the deity's old terracotta head with a new one. This new head is specially prepared and adorned with gems and other sacred materials.
                           The old terracotta head is ceremoniously immersed in the Purushottam Sagar tank, located near the temple.This ritual is often conducted with a degree of secrecy, and the specific details are not widely publicized. It signifies renewal and the cyclical nature of time.`,
                          `The festival of new rice, Nabanna, is celebrated after the harvest.The first harvested paddy is traditionally offered to Budharaja (a form of Bhairava, often considered the protector of the village or region), whose shrine is located within the premises of the Manikeswari Temple.This ritual takes place on Mahanavami, after the return of the Chhatar Jatra.
                          The royal family of Kalahandi and many devotees participate in this ritual, signifying gratitude for a good harvest and seeking blessings for future prosperity. After the offering, the new rice is consumed by the devotees.`],
          }
        ],
        calender: [
          {
        ...
        history: [
          {
            name: ['Legendary Origin'],
            img: [null],
            description: [` Goddess Manikeswari has been associated with the Kalahandi region since around the 10th century AD, revered as a deity of wealth ("Manik" meaning ruby). She was the presiding deity of the Chakrakota Mandala, which encompassed present-day Kalahandi, Koraput, and Bastar.
              The Chindaka Naga kings, who ruled in the 12th and 13th centuries, were also worshippers of Goddess Manikya Devi, another name for Manikeswari.Around 1200 AD, during the Naga dynasty's reign, the deity was brought to Kalahandi from Gadapur in the Phulbani district.
              Maa Manikeswari was installed in Bhawanipatna much later, around 1849 AD, when the capital shifted from Junagarh. Some accounts suggest Thuamul Rampur as the original seat (Adipitha) before her arrival in Bhawanipatna.
              The foundation of the present temple in Bhawanipatna was laid by King Udit Narayan Deo, and it was completed in 1947 by King Brajamohan Deo. The temple is built in the Rekha Deula style. Manikeswari is the primary deity of the royal families of Kalahandi and Paralakhemundi.
              The deity represents a blend of tribal and non-tribal cultures and is revered by both communities. Some scholars note a resemblance between the iconography of Manikeswari and Stambeswari (pillar worship), an ancient form of mother goddess worship prevalent in the region. The Kondh tribe also considers Manikeswari as the sister of their deity Dharnipenu.
              Interestingly, the Manikeswari deity in Bhawanipatna is headless. A clay head is fixed to a cylindrical body, which is then adorned with clothes and ornaments. This is linked to the goddess Chhinnamasta, one of the Dasamahavidya goddesses.`],
          }
        ],
      },
      {
        ...
        description: "The Belkhandi Temple, also known as the Uma Maheswar Temple or Dhabaleswar Temple, is a significant historical and religious site located in the Kalahandi district of Odisha. It's situated at the confluence of the Tel and Uttei rivers, about 67 kilometers from Bhawanipatna.",
        price: "$999",
        details: `Situated on the confluence of the river Tel and Uttei, two tributaries of the river Mahanadi, Belkhandi has gained prominence as a centre of religious activities and archaeological importance with a picture-sque site. Besides the temples now standing therein, ruuins of 12th Century monuments have been excavated from there in the recent past.
                  Among the sculptures unearthed images of Sapta Matruka (Seven Mother Goddesses) and Uma Maheswar are note-worthy. The ruins of Belkhandi are preserved in a small museum adjacent to the temple premises. It is also an ideal site for an outing. This place is 67 K.Ms from Bhawanipatna.Belkhandi was a prominent center of religious and archaeological activity. Ruins of 12th-century monuments have been excavated here, indicating its historical importance.
                  The region of Kalahandi, including Belkhandi, has a rich history dating back to prehistoric times, with evidence of Stone Age and megalithic settlements.
                  Temple architecture in Odisha reached a high point of perfection at Belkhandi before spreading to other regions like Bhubaneswar during the Somavamshi rule (10th-11th centuries AD).The currently standing Shiva temple is a beautiful example of traditional indigenous art from the Kalahandi district.`,
        rituals_img: [null,null,null,null,null,null,null,null,null],
        rituals_name: [`Temple Opening`,`Abhisheka`,`Shringar`,`Puja and Offerings`,`Morning Aarti`,`Midday Closure`,`Evening Opening and Prayers`,`Evening Aarti`,`Temple Closure`,],
        about_rituals: [`The temple doors are opened, often at dawn. The priests begin the day by cleaning the sanctum sanctorum (garbhagriha) and preparing for the morning rituals.`,
          ` A significant part of the morning ritual involves the abhisheka of the Shiva Lingam. This is a ceremonial bathing of the Lingam with various sacred substances such as water, milk, ghee (clarified butter), honey, yogurt, and sometimes fruit juices or other offerings. The specific substances used can vary. During the abhisheka, sacred hymns and mantras are chanted.`,
          `After the abhisheka, the Shiva Lingam and sometimes other deities in the temple complex are adorned with flowers, garlands, leaves (like bel patra which is particularly sacred to Shiva), and sometimes decorative clothes and ornaments.`,
          ` Priests perform puja (worship) by offering flowers, incense, lamps (deepa), and food (bhog or naivedya) to Lord Shiva. Devotees may also bring their own offerings during this time.`,
          `An aarti ceremony is usually conducted in the morning. This involves waving lamps (often with multiple wicks) before the deity, accompanied by the ringing of bells, the blowing of conch shells, and the chanting of hymns and prayers.`,
          `temples may close for a period in the afternoon.`,
          `The temple reopens in the late afternoon or early evening. Devotees gather for evening prayers and darshan (viewing the deity).`,
          `A second aarti ceremony is performed in the evening, similar to the morning aarti.`,
          ` The temple is closed for the night after the final rituals.`,
        ],
        festivals: [
          {
            name: [`Maha Shivaratri`],
            img: [],
            description: [`This is one of the most significant festivals dedicated to Lord Shiva and is celebrated with great fervor. It usually falls in the Hindu month of Phalguna (February/March). Devotees observe a day-long fast, offer prayers, perform abhisheka of the Shiva Lingam throughout the night, and participate in special rituals and cultural programs. The temple is likely to be  decorated, and large numbers of devotees visit.`
            ],
          }
        ],
        calender: [
    ...
    products: [
      {
        ...
        description: "The Tara-Tarini Temple, located on the Kumari Hills near Purushottampur in Ganjam district, Odisha, is one of the oldest Shakti Pithas in India. Believed to be the site where the breasts of Goddess Sati fell",
        price: "$999",
        details: `Tara Tarini Temple, located in the Ganjam district of Odisha, is one of the oldest and most revered pilgrimage sites in India. Situated on the Tarini Hill, the temple is dedicated to the twin goddesses Tara and Tarini, considered manifestations of the divine feminine power. The temple is perched at a height of about 2,000 feet and offers panoramic views of the surrounding landscape, making it both a spiritual and scenic destination.
                  ...
                  Perched atop the sacred Kumari Hills, overlooking the scenic Rushikulya River in the Ganjam district of Odisha, stands the prominent Tara Tarini Temple. This revered shrine is dedicated to the twin goddesses Tara and Tarini, believed to be powerful incarnations of the primordial Adi Shakti, and their divine presence is enhanced by exquisite gold and silver adornments.
                  Located approximately 35 kilometers from Berhampur and 25 kilometers from Chhatrapur, the temple is nestled within a verdant, hilly forest, creating a serene and spiritually charged atmosphere. Reaching the twin seats of the goddesses at the summit of Kumari Hills involves ascending 999 steps. Alternatively, a well-maintained road provides vehicular access to the sacred shrines, and for added convenience and breathtaking views, a ropeway has been constructed, offering an easy ascent for a nominal fee of around Rs 60 per person.
                  The Tara Tarini Temple is not merely a spiritual hub; it represents a captivating confluence of profound religious significance and captivating natural beauty, making it a cherished destination for both devout pilgrims and appreciative tourists.
                  The main festivals celebrated with immense enthusiasm here are the Chaitra Parba, Mela, and Yatra. Notably, a grand festival draws an exceptionally large number of devotees on the third Tuesday of every Chaitra month, dedicated to the worship of Maa Taratarini.
                  Since time immemorial, the sacred mountain, also known as Tarana, Kumari Hill, and Ratnagiri, has been the hallowed abode of Maa Taratarini. This temple holds immense significance as a renowned Shakti Peetha and Tantra Peetha of Odisha, its fame extending far beyond the Ganjam district, solidifying its position as one of the most esteemed religious and tourist sites in the state, particularly in the Berhampur region.`,
        rituals_img: [null,null,null,null,null,null,null,null],
        rituals_name: [` Majana`,`Mangala Alati & Pahili Bhog`,`Raja Bhog`,`Pahada`,`Reopening`,`Evening Majana`,`Sandhya Alati`,`Bhog & Pahada`],
        about_rituals: [`The deities are cleaned by the sevayats (temple servants) and then washed with holy water from the Rushikulya River, which is specially brought for this purpose.`,
          `The morning Aarti (waving of lamps) is performed along with the first food offering (Pahili Bhog). The main item in this offering is Khechodi (a rice and lentil dish), along with fruits and dry sweets.`,
          `A more elaborate midday food offering is presented to the goddesses. This includes items like Khechodi, Dal (lentils), various curries, Khata (a sour dish), and different sweets. After being offered, this bhoga is made available to the public.`,
          `The deities are put to rest during the day.`,
          `The temple reopens after the midday recess.`,
          ` A second cleaning ritual similar to the morning one is performed.`,
          `The evening Aarti is conducted.`,
          ` A final food offering for the night is made, followed by the night recess for the deities.`
        ],
        festivals:[
              {
        name:[`Chaitra Parba`,`Sankranti Mela`,],
        img:[],
        description:[` This is the most significant festival and is celebrated with great enthusiasm throughout the month of Chaitra (March-April). However, the Tuesdays of this month are particularly important, with the third Tuesday witnessing the largest congregation of devotees. During this festival, special rituals are performed, and devotees offer their children for tonsuring, which is considered auspicious. A special Khechidi Bhoga (rice and lentil offering) is also prepared and distributed.`,
          `This fair is held on the first day of every Hindu month (Sankranti). It is considered an auspicious day, especially for Tantra practitioners.`
        ],
            }
        ],
        calender: [
        ...
        name: ['Legendary Origin', 'Ancient Age'],
        img: [null, null],
        description: [` The Tara Tarini Temple is considered one of the Adi Shakti Peethas, believed to be the spot where the breasts of Maa Sati fell. This links its origin to a major pan-Indian mythological narrative. Ancient texts like the Kalika Purana (written around a thousand years ago) mention the Tara Tarini Shakti Peetha, indicating its antiquity and significance as a center of Shakti worship.
           Interestingly, the presence of a small Buddha statue within the garbhagriha suggests a possible historical connection to Buddhism in the region. Some historians propose a transformation of a tribal or Buddhist deity into the present Shakti cult. The name "Tara" itself is a significant deity in Mahayana Buddhism.One popular legend narrates the story of Basu Praharaj, a childless Brahmin who, through divine intervention and a grand Yagna, was blessed with twin daughters who later manifested as the goddesses Tara and Tarini on the Kumari Hills.
           Another legend attributes the temple's establishment to a king named Indradyumna who is said to have discovered the goddesses.While the exact date of the original construction is unclear, the current temple structure is believed to have been built around the 17th century. The temple has received patronage and undergone renovations by various rulers and later by the Tara Tarini Development Board. A devotee trader constructed the 999 steps in the early 20th century.
           Some historians suggest the worship of Tara Tarini evolved from a tribal cult that was later integrated into the Hindu Shakti tradition through Aryanization.The twin goddesses Tara and Tarini are regarded as the presiding deities (Ishta Devi) in many households across South Odisha and parts of North Andhra Pradesh, highlighting their deep-rooted cultural and religious importance in the region.`],
            }
          ],          
      },
      {
        id: 2702,
        name: "KOTESWAR SHIVA TEMPLE",
        ...
        image: "/adishaktipitha-img/Tara-Tarini-Temple.jpg",
        image_arr: ["/adishaktipitha-img/Tara-Tarini-Temple.jpg", "/ganjam-img/tara-tarini -temple.jpg"],
        description: " Koteswar Shiva Temple stands as a testament to Odisha’s rich cultural heritage and spiritual significance. This ancient shrine, dedicated to Lord Shiva",
        price: "$999",
        details: `Nestled in the heart of the Ganjam district, the Koteswar Shiva Temple stands as a profound testament to Odisha’s rich cultural heritage and deep spiritual significance. This ancient shrine, dedicated to Lord Shiva, transcends its role as a mere religious site, captivating tourists and devotees from across India and beyond with its history, architecture, and palpable spiritual aura. As we embark on a journey to explore this revered destination, recognized as one of the most significant tourist places in Odisha, prepare to be enchanted by its timeless charm.
                  The origins of the Koteswar Shiva Temple are steeped in compelling mythology and cherished local legends. According to ancient tales, the temple's sacred foundation was laid by none other than Lord Rama himself during his period of exile. It is believed that Rama personally installed the Shiva Linga at this very spot, bestowing upon the site its profound divine significance. This powerful mythological connection has established the temple as a central point of reverence for devotees and a source of fascination for history enthusiasts, adding a captivating layer of intrigue to Odisha’s extensive cultural landscape.`,
        rituals_img: [null,null,null,null,null,null,null,null],
        rituals_name: [`Temple Opening`,`Morning Ablutions (Majana)`,`Puja (Worship)`, `Abhishekam`,`Bhog (Food Offering)`,`Aarti`,`Devotee Offerings`,`Temple Closing`],
        about_rituals: [`The temple would open in the early morning, likely around sunrise, to allow devotees to offer prayers. `,
          `Similar to other temples, the Shiva Linga would be cleaned and prepared for worship. This might involve bathing it with water, and perhaps other sacred substances.`,
          `Daily prayers and worship would be offered to Lord Shiva. This would likely include the offering of flowers (especially white flowers and bilva leaves, which are significant for Shiva), incense, and the chanting of mantras dedicated to Lord Shiva, such as "Om Namah Shivaya."`,
          `The "abhishekam" (sacred bath) of the Shiva Linga with water, milk, ghee, honey, or other sacred substances is a common daily ritual in Shiva temples. The provided search result for the Koteswar Shiva Temple mentions this as a regular practice.`,
          ` An offering of food (bhog) would likely be made to Lord Shiva, which would later be distributed to devotees as Prasad.`,
          ` Morning and evening Aarti (waving of lamps before the deity while singing devotional hymns) would likely be performed. The search result mentions daily rituals maintaining the temple's spiritual rhythm.`,
          `Throughout the day, devotees would have the opportunity to offer their prayers, flowers, water, and other personal offerings to the Shiva Linga.`,
          `The temple would close in the evening after the final prayers and rituals.`,
        ],
        festivals:[
              {
        name:[`Maha Shivaratri`],
        img:[],
        description:[`The Koteswar Shiva Temple resonates with profound spiritual energy year-round, yet its vibrancy intensifies during its celebrated festivals. The most magnificent of these is Maha Shivaratri, an occasion that draws thousands of devoted pilgrims to the temple seeking the divine blessings of Lord Shiva. On this sacred night, the atmosphere becomes truly transcendent, filled with the powerful resonance of chanted mantras, the melodious peal of temple bells, and the fragrant embrace of incense. For visitors, it's an immersive and deeply spiritual experience that lingers long after departure.
                      The temple's spiritual rhythm is also meticulously maintained through its daily rituals, most notably the sacred abhishekam (bathing of the Shiva Linga) and the reverent offering of bhog (sanctified food). These time-honored practices offer a captivating glimpse into the enduring traditions of Hinduism, making the Koteswar Shiva Temple an indispensable destination for those seeking a deeper understanding of Odisha’s rich spiritual essence.`
        ],
            }
        ],
        calender: [
        ...
        name: ['Legendary Origin'],
        img: [null],
        description: [` The temple's origins are linked to the epic Ramayana. Local legends narrate that Lord Rama himself established the Shiva Linga at this site during his period of exile. This strong mythological connection significantly contributes to the temple's sanctity and draws devotees who revere its divine foundation.
          The temple is described as an ancient shrine, signifying its long-standing presence and importance in the region's religious landscape.The sanctum sanctorum houses an ancient Shiva Linga believed to be self-manifested (Swayambhu). This further enhances the temple's spiritual significance, as Swayambhu Lingas are considered particularly powerful.The temple's structure showcases the classic Kalinga architecture, a style indigenous to Odisha. This architectural style is characterized by its towering spire (Deul) and intricate carvings depicting scenes from Hindu mythology, particularly those related to Lord Shiva and his various avatars.`],
            }
          ],          
      },
    ]
    ...
    products: [
      {
        ...
        description: "  The Mahendragiri hills are steeped in mythology and are home to several ancient temples associated with the Puranas. It is believed that Lord Parshuram meditated here. Temples of Bhima, Kunti, and Yudhisthira are located on the hilltop.",
        price: "$999",
        details: ` Mahendragiri, nestled in Odisha's Eastern Ghats (40 km from Paralakhemundi), is a captivating destination where natural splendor intertwines with deep spiritual significance and ecological richness. This majestic hill, the second-highest peak in Odisha at approximately 1,501 meters (4,925 feet), is a haven for both pilgrims and nature enthusiasts.
                   Its verdant slopes are cloaked in dense forests, a vital ecological zone teeming with a remarkable biodiversity, including precious red sandalwood (Lal Chandan) and a wealth of medicinal plants. The region's diverse flora and fauna make it a proposed wildlife sanctuary, harboring numerous rare and endangered species within its tropical deciduous and evergreen forests. Cascading down its slopes, the Mahendratanaya River adds to the scenic allure, with numerous waterfalls, both small and large, gracing the foothills.
                   Steeped in ancient mythology, Mahendragiri resonates with tales from the Ramayana and Mahabharata. Legend recounts that Lord Parashurama, an avatar of Lord Vishnu, sought solace and performed penance on these very hills. The epic narratives also whisper of the Pandavas' sojourn here during their exile. Adding to its spiritual aura are several ancient temples dedicated primarily to Lord Shiva, drawing devotees, particularly during the auspicious festival of Maha Shivaratri. The temples of Bhima, Kunti (housing the unique Gokarneswar Linga), and Yudhisthira grace the hilltop, while the Parshuram Temple stands at the foothills near Tumba village, each echoing centuries of devotion.
                   Beyond its spiritual and ecological importance, Mahendragiri Hill Station beckons trekkers and nature lovers with its rugged terrain and breathtaking vistas. The optimal time to explore this enchanting region is between October and February, when the weather is most agreeable for outdoor activities.
                   Historically and mythologically significant, Mahendragiri finds mention as Mahendra Parvata in the Ramayana and is revered as a Kula Parvata, alongside other sacred mountains like Malaya, Sahyadri, Shuktiman, Vindhya, and Malyavaan. The Puranas narrate that Parashurama was in deep meditation here when Lord Rama broke Shiva's sacred bow. `,
        rituals_img: [null,null,null,null,null],
        rituals_name: [ `Awakening the Deity`,`Abhishekam and Vastra`,`Naivedyam or Bhog`,`Aarti`,`Prayers and Chanting`,`Darshan`,],
        about_rituals: [ ` this involves ringing bells and chanting to symbolically wake the deity.`,
          ` The idols may be ritually bathed with water, milk, or other sacred substances and then dressed in new clothes and adorned with flowers and ornaments. This might be a daily ritual for the main deities or less frequent for smaller shrines.`,
          `Cooked food, fruits, and sweets are offered to the deities. This offering becomes prasad after the deity has partaken of it (symbolically).`,
          ` A lamp (often with ghee or camphor) is waved before the deity while prayers or hymns are sung. This is a significant part of the daily ritual.`,
          ` Priests and devotees recite mantras and prayers.`,
          ` The period when devotees can view the deity and offer their prayers.`
        ],
        festivals:[
              {
        name:[`Maha Shivaratri`],
        img:[],
        description:[ ` This is highlighted as the main and most significant festival celebrated at Mahendragiri. Thousands of pilgrims from Odisha and Andhra Pradesh gather on the hilltop to worship Lord Shiva on this auspicious night. A special "Jagar Mela" (night vigil fair) is also associated with this festival, sometimes held a day before Maha Shivaratri.`
        ],
            }
        ],
        calender: [
        ...
        name: ['Legendary Origin'],
        img: [null],
        description: [`Mahendragiri is mentioned as Mahendra Parvata in ancient Hindu scriptures like the Ramayana, Mahabharata, and Puranas, identifying it as one of the seven "Kula Parvatas" or principal mountain ranges of India.Legend states that Lord Parashurama, an avatar of Vishnu, meditated here and is believed to reside eternally on these mountains.
          The epic Mahabharata recounts that the Pandava brothers visited Mahendragiri during their exile. Temples on the hill are attributed to them and their mother Kunti.Some local traditions link Mahendragiri to the Ramayana, suggesting Hanuman leaped towards Lanka from this peak.
          Historical evidence suggests Mahendragiri became a significant center for the worship of Lord Shiva (Gokarneswara) in South Odisha during the rule of the early Ganga and Sailodbhava dynasties.
          The hilltop contains archaeological remnants dating back to the Palaeolithic and early medieval periods, including the temples believed to have been built between the 4th and 10th centuries AD.
          Several inscriptions have been found on Mahendragiri, providing historical context. These include records of endowments to the Mahendreswara (Gokarneswara) temple dating back to the 12th century AD and mentions of Chola and Ganga rulers.`],
            }
          ],              
      },
    ]
    ...
    products: [
      {
        ...
        price: "$999",
        details: `Maa Managala Temple is a prominent Hindu temple located in the Kamakhya region of Guwahati, Assam. Dedicated to Goddess Managala, a form of Durga, the temple holds significant spiritual and cultural importance. The temple is located on a hilltop, offering panoramic views of the surrounding area, adding to its charm.
                  Goddess Managala is believed to be the protector of the devotees, bringing peace, prosperity, and blessings to her followers. The temple's architecture is traditional, with intricate carvings and a serene ambiance that enhances the spiritual experience. Devotees flock to the temple year-round, especially during festivals like Navaratri and Durga Puja, when grand celebrations take place.
                  The temple is also known for its peaceful atmosphere, where visitors often come to meditate and seek the Goddess's blessings. With its sacred aura, historical significance, and deep-rooted cultural values, Maa Managala Temple continues to be an essential pilgrimage site in Assam, attracting devotees from all over the country.`,
        upcoming_event: "no",
        event_name: "rath-yatra",
        event_img: "",
        event_period: "",
